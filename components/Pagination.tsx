  ...
  return (
    <div className="p-4 flex flex-col items-center text-gray-500 space-y-2 sm:space-y-0 sm:flex-row sm:justify-between sm:space-x-4">
      <div className="flex items-center gap-2 order-2 sm:order-1">
        <button
          disabled={!hasPrev}
          className="py-2 px-4 rounded-md  text-lg border-2  font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={() => {
            changePage(page - 1);
          }}
        >
        ...
        <button
          className="py-2 px-4 rounded-md  border-2 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          disabled={!hasNext}
          onClick={() => {
            changePage(page + 1);
          }}
