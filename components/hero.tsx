  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex justify-center items-center">
        <p className="heartbeat text-3xl lg:text-7xl !leading-tight mx-auto max-w-xl text-center">
          BUY! BUY! BUY!
        </p>
        <img src="/images/cartlogo.png" className="w-40 md:w-80" />
      </div>
      <div className="flex flex-col items-center m-10 p-5 text-xl">
        <h1 className="text-4xl">Welcome to Corp-O-Cart!</h1>
        <h2 className="mt-5">
        ...
        <p className="text-4xl mt-5 ">would you?</p>
      </div>
    </div>
  );
}
